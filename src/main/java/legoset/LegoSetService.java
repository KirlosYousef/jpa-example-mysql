...
public class LegoSetService {
    ...
    public LegoSetQLBVZH create(String number, String name, Year year, int pieces) {
       LegoSetQLBVZH legoSet = new LegoSetQLBVZH(number, name, year, pieces);
       em.persist(legoSet);
       return legoSet;
    }

    public Optional<LegoSetQLBVZH> find(String number) {
        return Optional.ofNullable(em.find(LegoSetQLBVZH.class, number));
    }

    public List<LegoSetQLBVZH> findAll() {
